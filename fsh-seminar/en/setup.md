# Course Setup - FSH Seminar v0.1.0
...
1. Install Ruby and Jekyll using[these OS-specific instructions](https://jekyllrb.com/docs/installation/#guides)
1. Install SUSHI using[these directions](https://fshschool.org/docs/sushi/installation/)
1. Download the syllabus IG from`https://github.com/FSHSchool/courses-fsh-seminar-exercise/archive/refs/heads/main.zip`and unzip it, or`git clone https://github.com/FSHSchool/courses-fsh-seminar-exercise.git`
1. Open a Terminal/Command Prompt window inside the IG folder, and run`./_updatePublisher.sh`(Mac/Linux) or`_updatePublisher.bat`(Windows) from the command line.
...
1. Run`./_genonce.sh`(Mac/Linux) or`_genonce.bat`(Windows)
1. Open`output/index.html`from inside your IG folder. You should see a mostly-empty IG home page that says "FSHSeminarExercise" on it.
